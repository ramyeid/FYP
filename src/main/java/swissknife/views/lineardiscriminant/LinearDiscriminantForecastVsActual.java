...
{
    public LinearDiscriminantForecastVsActual(String pathCsv, MainWindowFrame mainFrame)
    {
        this.add(new ClassifierPanel(new LDPredictVsActual(),pathCsv,this,mainFrame));
